...
class StitchesExport implements FromCollection,WithStyles,WithMapping,WithHeadings,WithProperties,ShouldAutoSize,WithTitle,WithCustomCsvSettings
{

    protected $ids = [];
    protected $for = 'Stitching';
    protected $title = 'Stitching export';
    ...
    {
        $model= \App\Models\Stitching::withCount('products');
