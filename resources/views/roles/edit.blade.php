               ...
               <div class="row form-material">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           <input type="text" class="form-control" id="name" error-text="Enter role name..." placeholder="Role Name" name="name" value="{{$role->name}}">
                        </div>
                        <!-- input-group -->
                  ...
                  <div class="col-md-6">
                     ...
                     <select error-text="Select platform" id="guard_name" name="guard_name" required class="select2 form-control mb-3 custom-select js-states form-control" style="width: 100%; height:36px;">
                           ...
                           <option @if($role->guard_name==$key) selected @endif value="{{$key}}">{{$key}}</option>
                           @endforeach
                    </select>   
...
<div class="col-md-3" >
         <h4 class="page-title font-16">Edit Permissions: </h4>
</div>
                                          ...
                                          @foreach($permissions as $id=>$permission)
                                                            <div class="form-check-inline my-2">
                                                               <div class="custom-control custom-checkbox">
                                                                  <input type="checkbox" @cannot('roles-auth-edit-permission-'.$role_name) disabled @endcannot @if(array_key_exists($id,$role_permissions)) checked @endif class="custom-control-input" id="customCheck{{$id}}" name="permissions[{{$id}}]" value="{{$id}}" data-parsley-multiple="groups" data-parsley-mincheck="2">
      ...
      <div class="col-md-12" id="button">
                  <div class="form-group text-center">
                     <input type="button" value="{{trans('Update Role')}}" id="submit-btn" class="btn btn-primary">
                  </div>
      </div>
