...
<div class="row">
   <div class="col-sm-12">
      <div class="page-title-box">
         <h4 class="page-title font-16">Granted Permissions: </h4>
      </div>
   </div>
</div>
               ...
               <div class="row form-material">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           <input class="form-control" disabled value="{{$user->first_name}} {{$user->last_name}}">
                        </div>
                        <!-- input-group -->
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                        <input class="form-control" disabled value="{{ucwords($user->roles->first()->name)}}">
